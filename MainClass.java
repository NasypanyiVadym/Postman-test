...
public class MainClass {
    public static void main(String[] args) {
        ...
        creator.typeMainFields("Vadim_Nasypanyi_4/3/20_16","test_Description");
        ...
        createFile.createFile("Vadim_Demo","class HelloWorld{public static void main(String[] args) {System.out.println('Hello_World!')}","Vadim_Commit_Demo_4/3_2020","Who is Real Pes?");
